...
struct ContentView: View {
    ...
    @State private var rotationSpeed: Double = 1
    @State private var textColor: Color = .primary
    @State private var containerBackgroundColor: Color = Color.primary.opacity(0.3)
        ...
        ZStack {
            VStack {
                ...
                VStack(alignment: .leading, spacing: 10, content: {
                    ...
                    Slider(value: $rotationSpeed, in: 0.5...10)
                        .padding(.leading)
                        .padding(.trailing)
                }).padding(.top, 30)
                ...
                VStack(alignment: .leading, spacing: 20, content: {
                    ...
                    if #available(iOS 14.0, *) {
                        ColorPicker("Set the background color", selection: $containerBackgroundColor)
                            .padding(.leading)
                            .padding(.trailing)
                    }
                }).padding(.top, 30)
